...
import com.yupi.springbootinit.model.enums.AppScoringStrategyEnum;
import com.yupi.springbootinit.model.enums.AppTypeEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (StringUtils.isNotBlank(appName)) {
            ThrowUtils.throwIf(appName.length() > 12, ErrorCode.PARAMS_ERROR, "标题过长");
        }
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(appType), "id", appType);
        queryWrapper.eq(ObjectUtils.isNotEmpty(scoringStrategy), "scoringStrategy", scoringStrategy);
        queryWrapper.eq(ObjectUtils.isNotEmpty(reviewStatus), "reviewStatus", reviewStatus);
        queryWrapper.eq(ObjectUtils.isNotEmpty(scoringStrategy), "reviewerId", reviewerId);
